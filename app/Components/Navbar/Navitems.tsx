...
const Navitems: NextPage<NavitemProps> = ({ isHidden, setIsHidden }) => {
  return (
    <>
      ...
      <div
        className={` md:w-auto w-full justify-center rounded-2xl border-2 border-white border-solid flex text-white md:py-1 py-2 `}
      >
      ...
      <div className="flex md:w-auto w-full justify-center">result</div>
      <div className="flex  md:w-auto w-full justify-center ">
        <div>more</div>
        <div className="relative w-6 h-6">
          <Image src="/expand_more (1).svg" alt="" fill />
